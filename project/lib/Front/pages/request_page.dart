...
import 'package:project/front/components/requests/elements/delete_button.dart';
import 'package:project/front/components/requests/elements/informations.dart';
import 'package:project/front/components/requests/elements/text_requests.dart';
                                  ...
                                  builder: (BuildContext context) {
                                    ...
                                    return Container(
                                      ...
                                      child: Container(
                                        ...
                                        height:
                                            Style.InternalModalSize(context),
                                        margin: EdgeInsets.only(
                                            left: Style.ModalMargin(context),
                                            right: Style.ModalMargin(context)),
                                        padding: EdgeInsets.all(
                                            Style.InternalModalPadding(
                                                context)),
                                        decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(
                                                Style.ModalBorderRadius(
                                                    context))),
                                        child: Column(
                                          ...
                                          Stack(
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  Informations(
                                                    empresaNome: requests[index]
                                                        .empresaNome,
                                                    usuarioLogin:
                                                        requests[index]
                                                            .usuarioLogin,
                                                    imagem:
                                                        requests[index].imagem,
                                                    urlBasic: urlBasic,
                                                  ),
                                                  DeleteButton(
                                                      onPressed: () async {
