...
class _ContentVerificationState extends State<ContentVerification> {
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Column(
        children: [
          if (widget.empresasHoje.isNotEmpty &&
                        ...
                        children: [
                          Column(
                            children: [
                              CompanyNameButton(
                                empresaNome:
                                    widget.empresasHoje[index].empresaNome,
                                valorHoje:
                                    widget.empresasHoje[index].valortotal,
                                ticketHoje: widget
                                    .empresasHoje[index].valortotal
                                    .toInt(),
                                valorcancelamentosHoje:
                                    widget.empresasHoje[index].valortotal,
                                cancelamentosHoje:
                                    widget.empresasHoje[index].valortotal,
                                ticketmedioHoje:
                                ...
                                valorOntem:
                                    widget.empresasOntem[index].valortotal,
                                ticketOntem:
                                    widget.empresasOntem[index].ticket.toInt(),
                                valorcancelamentosOntem: widget
                                    .empresasOntem[index].valorcancelamentos,
                                cancelamentosOntem:
                                    widget.empresasOntem[index].cancelamentos,
                                ticketmedioOntem:
                                    widget.empresasOntem[index].ticketmedio,
                                margemOntem: widget.empresasOntem[index].margem,
                                metaOntem: widget.empresasOntem[index].meta,
                                valorSemana:
                                    widget.empresasSemana[index].valortotal,
                                ticketSemana:
                                    widget.empresasSemana[index].ticket.toInt(),
                                valorcancelamentosSemana: widget
                                    .empresasSemana[index].valorcancelamentos,
                                cancelamentosSemana:
                                    widget.empresasSemana[index].cancelamentos,
                                ticketmedioSemana:
                                    widget.empresasSemana[index].ticketmedio,
                                margemSemana:
                                    widget.empresasSemana[index].margem,
                                metaSemana: widget.empresasSemana[index].meta,
                                valorMes: widget.empresasMes[index].valortotal,
                                ticketMes:
                                    widget.empresasMes[index].ticket.toInt(),
                                valorcancelamentosMes: widget
                                    .empresasMes[index].valorcancelamentos,
                                cancelamentosMes:
                                    widget.empresasMes[index].cancelamentos,
                                ticketmedioMes:
                                    widget.empresasMes[index].ticketmedio,
                                margemMes: widget.empresasMes[index].margem,
                                metaMes: widget.empresasMes[index].meta,
                                valorMesAnt:
                                    widget.empresasMesAnt[index].valortotal,
                                ticketMesAnt:
                                    widget.empresasMesAnt[index].ticket.toInt(),
                                valorcancelamentosMesAnt: widget
                                    .empresasMesAnt[index].valorcancelamentos,
                                cancelamentosMesAnt:
                                    widget.empresasMesAnt[index].cancelamentos,
                                ticketmedioMesAnt:
                                    widget.empresasMesAnt[index].ticketmedio,
                                margemMesAnt:
                                    widget.empresasMesAnt[index].margem,
                        ...
                        children: [
                          Column(
                            children: [
                              CompanyNameButton(
                                empresaNome:
                                    widget.empresasOntem[index].empresaNome,
                                valorHoje: 0,
                                ticketHoje: 0,
          ...
          if (widget.empresasHoje.isEmpty &&
              widget.empresasOntem.isEmpty &&
              widget.empresasMesAnt.isEmpty)
            ListView.builder(
                physics: NeverScrollableScrollPhysics(),
                shrinkWrap: true,
                        ...
                        children: [
                          Column(
                            children: [
                              CompanyNameButton(
                                empresaNome:
                                    widget.empresasSemana[index].empresaNome,
                                valorHoje: 0,
                                ticketHoje: 0,
                                valorcancelamentosHoje: 0,
                                cancelamentosHoje: 0,
                        ...
                        children: [
                          Column(
                            children: [
                              CompanyNameButton(
                                empresaNome:
                                    widget.empresasMes[index].empresaNome,
                                valorHoje: 0,
                                ticketHoje: 0,
                                valorcancelamentosHoje: 0,
                                cancelamentosHoje: 0,
                        ...
                        Column(
                          children: [
                            CompanyNameButton(
                              ...
                              ticketHoje:
                                  widget.empresasHoje[index].valortotal.toInt(),
                              valorcancelamentosHoje:
                                  widget.empresasHoje[index].valortotal,
                              cancelamentosHoje:
                                  widget.empresasHoje[index].valortotal,
                              ...
                              metaHoje: widget.empresasHoje[index].valortotal,
                              valorOntem:
                                  widget.empresasOntem[index].valortotal ?? 0.0,
                              ticketOntem:
                                  widget.empresasOntem[index].ticket.toInt(),
                              valorcancelamentosOntem: widget
                                  .empresasOntem[index].valorcancelamentos,
                              ...
                              ticketMes:
                                  widget.empresasMes[index].ticket.toInt(),
                              valorcancelamentosMes:
                                  widget.empresasMes[index].valorcancelamentos,
                              cancelamentosMes:
                                  widget.empresasMes[index].cancelamentos,
                              ticketmedioMes:
                                  widget.empresasMes[index].ticketmedio,
