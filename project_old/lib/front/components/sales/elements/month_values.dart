...
import 'package:project/front/components/sales/elements/text_card_sales.dart';
              ...
              children: [
                Column(
                  children: [
                    ...
                    TextCardSales(text: widget.cancelamentosMes.toString())
                  ],
                ),
                Column(
                  children: [
                    ...
                    TextCardSales(
                        text:
                            currencyFormat.format(widget.valorcancelamentosMes))
                  ],
                ),
              ],
            ),
